...
export const config = {
  api: {
    bodyParser: false, // ⛔️ disable Next.js body parsing
  },
};
...
// // ✅ Use Service Role Key for secure DB writes
...
//         if (!form_id) {
//           console.error("❌ No form_id found in session metadata");
//           break;
//         }

//         console.log(`✅ Checkout session completed for form_id: ${form_id}`);
...
//         else console.log(`✅ form_submissions updated for form_id: ${form_id}`);
...
//       case "payment_intent.succeeded": {
//         const paymentIntent = event.data.object;
//         const form_id = paymentIntent.metadata?.form_id;

//         if (!form_id) {
//           console.error("❌ No form_id in paymentIntent metadata");
//           break;
//         }

//         console.log(`✅ Payment intent succeeded for form_id: ${form_id}`);
...
//         if (error) console.error("❌ Supabase update failed:", error);
//         else console.log(`✅ Payment marked as paid for form_id: ${form_id}`);
