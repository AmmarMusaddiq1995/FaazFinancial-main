        ...
        <div className="max-w-2xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-8">
            <Link href="/start-business">
              <Button
                size="lg"
                className="bg-primary hover:bg-primary/90  hover:shadow-primary/20 hover:scale-115 transition-all duration-300 cursor-pointer text-primary-foreground px-8 py-4 text-lg"
              >
                Get started
              </Button>
            </Link>
