...
export function ComplexCorpTaxReturnPage() {
  ...
  const steps = [
    {
      ...
      validate: () => {
        ...
        if (!formData.statutoryAnnualAccountsFiled)
          return "Please tell us if your statutory annual accounts are filed.";
        return "";
      },
      content: (
        <>
          ...
          <div className="space-y-2">
            <Label>Statutory/Full annual accounts filed ?</Label>
            <OptionToggle
              options={[
                { value: "yes", label: "Yes" },
                { value: "no", label: "No" },
          ...
          <PriceSummary
            price={COMPLEX_CT600_PRICE}
            rows={[
              { label: "Complex Corporation Tax Return (CT600)", amount: COMPLEX_CT600_PRICE },
            ]}
          />
        </>
      ),
  ...
  return (
    <FormWizard
      title="Start Your Complex Corporation Tax Return (CT600)"
      description="Fill out the form below to begin your Complex Corporation Tax Return (CT600) process"
      steps={steps}
      onSubmit={handleSubmit}
      loading={loading}
      submitLabel="Start Complex Corporation Tax Return (CT600)"
      price={COMPLEX_CT600_PRICE}
    />
  );
}
